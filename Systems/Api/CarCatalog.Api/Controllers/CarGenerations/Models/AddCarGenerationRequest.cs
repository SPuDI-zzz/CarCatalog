...
public class AddCarGenerationRequest
{
...
public class AddCarGenerationRequestValidator : AbstractValidator<AddCarGenerationRequest>
{
    public AddCarGenerationRequestValidator()
    {
        RuleFor(x => x.Name)
...
public class AddCarGenerationRequestProfile : Profile
{
    public AddCarGenerationRequestProfile()
    {
        CreateMap<AddCarGenerationRequest, AddCarGenerationModel>();
    }
}
